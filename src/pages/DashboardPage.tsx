...
import type { Link, CreateLinkInput, UpdateLinkInput, LinkSort } from '../types';
...
export function DashboardPage() {
  ...
  const handleAddLink = useCallback(
    async (data: CreateLinkInput, analysis?: LinkAnalysis) => {
      if (!user?.id) return;

      const result = await linkService.createLink(user.id, data);
